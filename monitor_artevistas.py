...
def enviar_resumen_diario() -> None:
    ...
    # Guardar ventas en acumulador mensual
    if cambios_del_dia:
...
def main() -> None:
    ...
    # Si al arrancar se detectaron cambios (servicio estaba dormido),
    # enviar email inmediatamente sin esperar a las 20:00
    if cambios_del_dia:
        logging.info("⚠️  Cambios detectados al arrancar — enviando email inmediato.")
